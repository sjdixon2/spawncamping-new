...
global.testHelpers = requireAll(system.pathTo('/test/general/helpers/')); //Collection of helper functions for testing

global.Factories = requireAll(system.pathTo('test/general/factories')); //Load factories
